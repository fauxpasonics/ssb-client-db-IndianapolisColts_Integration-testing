...
AND SourceSystem LIKE '%SFDC%' --updateme
...
SELECT SSB_CRMSYSTEM_ACCT_ID, MaxTransDate, NULL, NULL, CRM
, 0 CriteriaMet
...
SELECT SSB_CRMSYSTEM_ACCT_ID, SSB_CRMSYSTEM_CONTACT_ID, MaxTransDate, NULL, NULL, CRM
, 0 
